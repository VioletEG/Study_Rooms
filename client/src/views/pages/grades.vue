	...
	<div class="fater-body-show">
        <Card>
			...
			<div>
				<Form :model="qryForm" inline>
					<FormItem prop="name">
						<Input type="text" v-model="qryForm.name" placeholder="专业名称……"></Input>
					</FormItem>
					<FormItem>
        ...
        <Modal v-model="showAddFlag"
			...
			<Form :label-width="80" :model="gradeForm">
				<FormItem label="专业名称" prop="reord">
					<Input v-model="gradeForm.name" placeholder="请输入专业名称..."></Input>
				</FormItem>
			</Form>
		</Modal>
    ...
    data(){
        return {
            ...
            columns: [
                ...
                {title: '专业名称', key: 'name', align: 'center'},
